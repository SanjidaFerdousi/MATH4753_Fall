#' Maximum Likelihood Estimation for Normal Distributions
#'
#' @param x A numeric vector representing the sample data.
#' @param mu A numeric vector of values for the mean (mu) parameter to be tested.
#' @param sig A numeric vector of values for the standard deviation (sigma) parameter to be tested.
#' @param ... Additional arguments to be passed to the contour plotting function.
#'
#' @return A list containing:
#'   \item{x}{The original sample data vector.}
#'   \item{coord}{The coordinates of the maximum likelihood estimates in the grid.}
#'   \item{maxl}{The maximum value of the likelihood function.}
#'
#'
#' @export
#'
#' @examples
#' mymlnorm(x=c(10, 12, 13, 15, 12, 11, 10),
